...
function asignarJsConfig(obj) {
  ...
  jsConfig.times = [...obj.times];
  jsConfig.every = obj.every;
}

function asignarPyConfig(obj) {
  console.log("valor de pyConfig:", obj)
...
function getSavedData(jsData, pyData) {
  ...
  console.log("jsData: ",savedJsData);
  console.log("PyData: ", savedPyData);
  console.log(savedPyData.phone)
  if (savedJsData != (undefined || null || "")) { asignarJsConfig(savedJsData) } else { console.error("Error al cargar JsConfig") };
  if (savedPyData != (undefined || null || "")) { asignarPyConfig(savedPyData) } else { console.error("Error al cargar PyConfig") };
